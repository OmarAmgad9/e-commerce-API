...
export class UsersService {
  ...
  userImage: string = '';
  constructor(private _GlobalService: GlobalService, private _HttpClient: HttpClient, private CookieService:CookieService) {
    this.baseUrl = _GlobalService.baseUrl;
    this.usersRoute = _GlobalService.userRoute;
    this.userImage = _GlobalService.usersImage;
